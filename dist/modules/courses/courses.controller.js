...
let CoursesController = class CoursesController {
    ...
    async enrollCourse(courseId, req) {
...
__decorate([
    (0, common_1.Post)(),
    (0, roles_decorator_1.Roles)(roles_enums_1.UserRole.TRAINER),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(roles_enums_1.UserRole.TRAINER, roles_enums_1.UserRole.ADMIN),
    (0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard, role_guard_1.RoleGuard),
    (0, swagger_1.ApiBearerAuth)(),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
